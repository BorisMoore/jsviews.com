...
QUnit.test("jQuery global: require('jquery.observable')", function(assert) {
	...
	var $jsr = require('jsviews/jquery.observable'); // Uses global jQuery, so $jsr === global.jQuery is global jQuery namespace
	var result = "";
