...
QUnit.test("No jQuery global: require('jquery.observable')", function(assert) {
	...
	var $jsr = require('jsviews/jquery.observable')($jq); // Provide jQuery, so $jsr === $jq is local jQuery namespace && !$jsr.templates
