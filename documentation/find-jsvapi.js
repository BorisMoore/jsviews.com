...
content.find.jsvapi = content.useStorage && JSON.parse(localStorage.getItem("JsViewsDocTopics/find/jsvapi")) ||
{
  "jsvapi": {
    "sections": [
      {
  ...
  "jsvcheckboxgrouptag": {
    "sections": [
      ...
      },
      {
        "_type": "para",
        "title": "",
        "text": "Note: The data-driven set of checkboxes can change dynamically, driven by {^{for}}, analagously to this sample for radio buttons. See also this advanced sample.\n"
      },
      {
        "_type": "para",
