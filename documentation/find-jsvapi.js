  ...
  "link-input": {
    "sections": [
      ...
      },
      {
        ...
        "text": "Checkbox groups – with converters\nIn this example we use convert and convert back converters to convert from the an array of integers – the indices of the items in the sports array to an array of strings – the id values, and back.\nWe also show this both for the {{checkboxgroup}} approach and for direct data-linking to the <input>s, as well as the corresponding <select multiple> UI.\n"
      },
      {
        "_type": "sample",
        "title": "",
