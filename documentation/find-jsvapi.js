  ...
  "tagoptions": {
    "sections": [
      ...
      },
      {
        ...
        "text": "The linkedElement option\nOften a tag control incorporates one or more textboxes, checkboxes, or other form elements. The  linkedElement option together with the bindTo option make it easy provide two-way data binding between such an element (or elements) and a tag argument or property.\nThe following sample shows a {{namebox}} tag control with two textboxes (for first and last names) – data-linked to the first and second tag arguments:\n"
      },
      {
        "_type": "sample",
  ...
  "bindingpatterns": {
    "sections": [
      ...
      },
      {
        "_type": "para",
        "title": "",
        "text": "Next we replace the boundProps option setting by the bindTo option, to allow two-way binding of the tab property. This will enable us to persist changes in the {{tabs}} control state by calling tag.updateValue() (see also the setValue and updateValue pattern below).\n"
      },
      {
        "_type": "sample",
