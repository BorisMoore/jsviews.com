    ...
    "sections": [
      {
        "_type": "para",
        "title": "",
        "text": "JsRender and JsViews are designed to work well with either plain JavaScript objects and arrays, or with instances of JavaScript classes, such as View Model classes."
      },
      {
        "_type": "para",
        "title": "",
      ...
      {
        "_type": "code",
        "title": "Example - data from JSON request:",
        "code": "var person = {\n  name: \"Pete\",\n  address: {\n    street: \"1st Ave\",\n  },\n  phones: [{number: \"111 111 1111\"}, {number:\"222 222 2222\"}] \n};\n"
      },
      {
        "_type": "template",
        "title": "Template:",
        "markup": "<table class=\"nowidth\"><tbody>\n  ... {{:name}}\n  ...\n  {{for phones}}\n    ...      \n    {{:number}}\n    ...\n  {{/for}}\n..."
      },
      {
        "_type": "sample",
        "typeLabel": "Sample:",
