...
content.find.download = content.useStorage && JSON.parse(localStorage.getItem("JsViewsDocTopics/find/download")) ||
{
  "download": {
    "sections": [
      {
      ...
      },
      {
        "_type": "para",
        "title": "CDN delivery",
        "text": "CDN delivery\nJsRender and JsViews are available on the jsDelivr CDN at:\n\njsdelivr.com/package/npm/jsrender\njsdelivr.com/package/npm/jsviews\n\nand on the unpkg CDN at:\n\napp.unpkg.com/jsrender\napp.unpkg.com/jsviews\n\nand on the cdnjs CDN at:\n\ncdnjs.com/libraries/jsrender\ncdnjs.com/libraries/jsviews\n\n"
      }
    ]
  },
