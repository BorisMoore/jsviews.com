...
content.find.samples = content.useStorage && JSON.parse(localStorage.getItem("JsViewsDocTopics/find/samples")) ||
{
  "samples": {
    "sections": [
      {
