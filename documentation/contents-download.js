...
content.download = content.useStorage && JSON.parse(localStorage.getItem("JsViewsDocTopics/download")) ||
{
  "download": {
    ...
    "sections": [
      ...
      },
      {
        "_type": "para",
        "title": "CDN delivery",
        "text": "JsRender and JsViews are available on the **[jsDelivr](https://www.jsdelivr.com/)** CDN at:\n\n- [jsdelivr.com/package/npm/jsrender](https://jsdelivr.com/package/npm/jsrender?tab=files)\n- [jsdelivr.com/package/npm/jsviews](https://jsdelivr.com/package/npm/jsviews?tab=files)\n\nand on the **[unpkg](https://unpkg.com)** CDN at:\n\n- [app.unpkg.com/jsrender](https://app.unpkg.com/jsrender)\n- [app.unpkg.com/jsviews](https://app.unpkg.com/jsviews)\n\nand on the **[cdnjs](https://cdnjs.com)** CDN at:\n\n- [cdnjs.com/libraries/jsrender](https://cdnjs.com/libraries/jsrender)\n- [cdnjs.com/libraries/jsviews](https://cdnjs.com/libraries/jsviews)",
        "anchor": "cdn"
      }
    ]
  },
  ...
  "download/pages-jsr-jq": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "text": "*Using latest version, minified, from www.jsviews.com:*\n\n```jsr\n<script src=\"https://www.jsviews.com/download/jsrender.min.js\"></script>\n```\n*Using a specific version from* __jsDelivr__ *CDN:*\n\n```jsr\n<script src=\"https://cdn.jsdelivr.net/npm/jsrender@1.2.0/jsrender.js\"></script>\n```\n*or from* __unpkg__ *CDN:*\n\n```jsr\n<script src=\"https://unpkg.com/jsrender@1.2.0/jsrender.js\"></script>\n```\n*or from* __cdnjs__ *CDN:*\n\n```jsr\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsrender/1.2.0/jsrender.js\"></script>\n```\n*Using a specific version, minified, from* __jsDelivr__ *CDN:*\n\n```jsr\n<script src=\"https://cdn.jsdelivr.net/npm/jsrender@1.2.0/jsrender.min.js\"></script>\n```\n*or from* __unpkg__ *CDN:*\n\n```jsr\n<script src=\"https://unpkg.com/jsrender@1.2.0/jsrender.min.js\"></script>\n```\n*or from* __cdnjs__ *CDN:*\n\n```jsr\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsrender/1.2.0/jsrender.min.js\"></script>\n```\n\n*Loading from the file system after* [Bower](http://bower.io/search/?q=jsrender) *install:*\n\n-- Install JsRender on local file system, using `$ bower install jsrender`<br/>-- then load `jsrender.js` or `jsrender.min.js` from the `bower_components/jsrender/` folder, as in:\n\n```jsr\n<script src=\"bower_components/jsrender/jsrender.js\"></script>\n```"
      }
    ]
  },
  "download/pages-jsr": {
  ...
  "download/pages-jsv": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "text": "*Using latest version, minified, from www.jsviews.com:*\n\n```jsr\n<script src=\"https://www.jsviews.com/download/jsviews.min.js\"></script>\n```\n\n*Using a specific version from* __jsDelivr__ *CDN:*\n\n```jsr\n<script src=\"https://cdn.jsdelivr.net/npm/jsviews@1.2.0/jsviews.js\"></script>\n```\n\n*or from* __unpkg__ *CDN:*\n\n```jsr\n<script src=\"https://unpkg.com/jsviews@1.2.0/jsviews.js\"></script>\n```\n\n*or from* __cdnjs__ *CDN:*\n\n```jsr\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsviews/1.2.0/jsviews.js\"></script>\n```\n\n*Using a specific version, minified, from* __jsDelivr__ *CDN:*\n\n```jsr\n<script src=\"https://cdn.jsdelivr.net/npm/jsviews@1.2.0/jsviews.min.js\"></script>\n```\n\n*or from* __unpkg__ *CDN:*\n\n```jsr\n<script src=\"https://unpkg.com/jsviews@1.2.0/jsviews.min.js\"></script>\n```\n\n*or from* __cdnjs__ *CDN:*\n\n```jsr\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsviews/1.2.0/jsviews.min.js\"></script>\n```\n\n*Loading from the file system after* [Bower](http://bower.io/search/?q=jsviews) *install:*\n\n-- Install JsViews on local file system, using `$ bower install jsviews`<br/>-- then load `jsviews.js` or `jsviews.min.js` from the `bower_components/jsviews/` folder, as in:\n\n```jsr\n<script src=\"bower_components/jsviews/jsviews.js\"></script>\n```"
      },
      {
        "_type": "para",
        "title": "",
      ...
      },
      {
        ...
        "text": "*Using latest version, minified, from www.jsviews.com:*\n\n```jsr\n<script src=\"https://www.jsviews.com/download/jsrender.min.js\"></script>\n<script src=\"https://www.jsviews.com/download/jquery.observable.min.js\"></script>\n<script src=\"https://www.jsviews.com/download/jquery.views.min.js\"></script>\n```\n\n*Using a specific version from* __jsDelivr__ *CDN:*\n\n```jsr\n<script src=\"https://cdn.jsdelivr.net/npm/jsviews@1.2.0/jsrender.js\"></script>\n<script src=\"https://cdn.jsdelivr.net/npm/jsviews@1.2.0/jquery.observable.js\"></script>\n<script src=\"https://cdn.jsdelivr.net/npm/jsviews@1.2.0/jquery.views.js\"></script>\n```\n\n*or from* __unpkg__ *CDN:*\n\n```jsr\n<script src=\"https://unpkg.com/jsviews@1.2.0/jsrender.js\"></script>\n<script src=\"https://unpkg.com/jsviews@1.2.0/jquery.observable.js\"></script>\n<script src=\"https://unpkg.com/jsviews@1.2.0/jquery.views.js\"></script>\n```\n\n*or from* __cdnjs__ *CDN:*\n\n```jsr\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsviews/1.2.0/jsrender.js\"></script>\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsviews/1.2.0/jquery.observable.js\"></script>\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsviews/1.2.0/jquery.views.js\"></script>\n```\n\n*Using a specific version, minified, from* __jsDelivr__ *CDN:*\n\n```jsr\n<script src=\"https://cdn.jsdelivr.net/npm/jsviews@1.2.0/jsrender.min.js\"></script>\n<script src=\"https://cdn.jsdelivr.net/npm/jsviews@1.2.0/jquery.observable.min.js\"></script>\n<script src=\"https://cdn.jsdelivr.net/npm/jsviews@1.2.0/jquery.views.min.js\"></script>\n```\n\n*or from* __unpkg__ *CDN:*\n\n```jsr\n<script src=\"https://unpkg.com/jsviews@1.2.0/jsrender.min.js\"></script>\n<script src=\"https://unpkg.com/jsviews@1.2.0/jquery.observable.min.js\"></script>\n<script src=\"https://unpkg.com/jsviews@1.2.0/jquery.views.min.js\"></script>\n```\n\n*or from* __cdnjs__ *CDN:*\n\n```jsr\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsviews/1.2.0/jsrender.min.js\"></script>\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsviews/1.2.0/jquery.observable.min.js\"></script>\n<script src=\"https://cdnjs.cloudflare.com/ajax/libs/jsviews/1.2.0/jquery.views.min.js\"></script>\n```\n\n*Loading from the file system after* [Bower](http://bower.io/search/?q=jsviews) *install:*\n\n-- Install JsViews on local file system, using `$ bower install jsviews`<br/>-- then load the corresponding `.js` or `.min.js` files from the `bower_components/jsviews/` folder, as in:\n\n```jsr\n<script src=\"bower_components/jsviews/jsrender.js\"></script>\n<script src=\"bower_components/jsviews/jquery.observable.js\"></script>\n<script src=\"bower_components/jsviews/jquery.views.js\"></script>\n```"
      }
    ]
  },
