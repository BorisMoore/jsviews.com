    ...
    "sections": [
      {
        "_type": "para",
        "title": "",
        "text": "<h3>Latest versions:</h3>\n\nThese links will always point to the latest version. (They move to the new current version with each new release).\n\n<em>To download these files, right-click and select \"Save as...\" from the menu.</em>\n\n<div class=\"title\">JsRender</div>\n\nUncompressed (for development): <a href=\"download/jsrender.js\">jsrender.js</a>.<br/>Compressed (for production): <a href=\"download/jsrender.min.js\">jsrender.min.js</a>. (Source map available <a href=\"download/jsrender.min.js.map\">here</a>).\n\n<div class=\"title\">JsViews - single file <span>(includes JsRender, JsObservable and JsViews)</span></div>\n\nUncompressed (for development): <a href=\"download/jsviews.js\">jsviews.js</a>.<br/>Compressed (for production): <a href=\"download/jsviews.min.js\">jsviews.min.js</a>. (Source map available <a href=\"download/jsviews.min.js.map\">here</a>).\n\n<div class=\"title\">JsViews and JsObservable - separate files <span>(to be used with jsrender.js)</span></div>\n\nUncompressed (for development): <a href=\"download/jquery.views.js\">jquery.views.js</a>.<br/>Compressed (for production): <a href=\"download/jquery.views.min.js\">jquery.views.min.js</a>. (Source map available <a href=\"download/jquery.views.min.js.map\">here</a>).\n\nUncompressed (for development): <a href=\"download/jquery.observable.js\">jquery.observable.js</a>.<br/>Compressed (for production): <a href=\"download/jquery.observable.min.js\">jquery.observable.min.js</a>. (Source map available <a href=\"download/jquery.observable.min.js.map\">here</a>).\n\n<div class=\"title\">JsRender for Node.js</div>\n\nA specific Node.js version of JsRender can be installed from <a href=\"https://www.npmjs.com/package/jsrender\">NPM</a>, using:\n\n```js\n$ npm install jsrender\n```\n\nand then loaded in script using:\n\n```js\nvar tmpl = require('jsrender');\n```\n\nThis Node.js version of JsRender provides the complete set of JsRender APIs and features, together with integration with view-engines such as <em>Express</em> and <em>Hapi</em>, APIs for loading templates from the file system, and integration with <em>Browserify</em> for bundling server-side templates into client scripts for the browser.\n\nSee <a href=\"https://github.com/BorisMoore/jsrender-node-starter\">JsRender Node Starter</a> for details."
      }
    ]
  },
  "download/specific": {
    ...
    "sections": [
      ...
      },
      {
        "_type": "para",
        "title": "",
        "text": "<h3>Specific named versions:</h3>\n\n(These links will continue to point to the specific version, even after subsequent new releases).\n\n<em>To download these files, right-click and select \"Save as...\" from the menu.</em>\n\n<div class=\"title\">JsRender beta</div>\n\n<em>Status: JsRender is currently beta. V1.0 is planned to be available right after JsViews official beta release is complete.</em>\n\nUncompressed (for development): <a href=\"download/jsrender-v1.0.0-beta.js\">jsrender-v1.0.0-beta.js</a>.<br/>Compressed (for production): <a href=\"download/jsrender-v1.0.0-beta.min.js\">jsrender-v1.0.0-beta.min.js</a>. (Source map available <a href=\"download/jsrender-v1.0.0-beta.min.js.map\">here</a>).\n\n<div class=\"title\">JsViews pre beta</div>\n\n<em>Status: JsViews is currently a beta candidate. It will be officially labelled \"beta\" as soon as reasonably complete documentation for the JsViews and JsObservable APIs has been made available on this site. (Coming soon...)</em>\n\n<b>Single file version </b><em>(includes JsRender, JsObservable and JsViews)</em>\n\nUncompressed (for development): <a href=\"download/jsviews-v1.0.0-alpha.js\">jsviews-v1.0.0-alpha.js</a>.<br/>Compressed (for production): <a href=\"download/jsviews-v1.0.0-alpha.min.js\">jsviews-v1.0.0-alpha.min.js</a>. (Source map available <a href=\"download/jsviews-v1.0.0-alpha.min.js.map\">here</a>).\n\n<b>Separate files </b><em>(to be used with jsrender.js)</em>\n\nUncompressed (for development): <a href=\"download/jquery.views-v1.0.0-alpha.js\">jquery.views-v1.0.0-alpha.js</a>.<br/>Compressed (for production): <a href=\"download/jquery.views-v1.0.0-alpha.min.js\">jquery.views-v1.0.0-alpha.min.js</a>. (Source map available <a href=\"download/jquery.views-v1.0.0-alpha.min.js.map\">here</a>).\n\nUncompressed (for development): <a href=\"download/jquery.observable-v1.0.0-alpha.js\">jquery.observable-v1.0.0-alpha.js</a>.<br/>Compressed (for production): <a href=\"download/jquery.observable-v1.0.0-alpha.min.js\">jquery.observable-v1.0.0-alpha.min.js</a>. (Source map available <a href=\"download/jquery.observable-v1.0.0-alpha.min.js.map\">here</a>)."
      }
    ]
  },
