...
interface FilterHandler {
	...
	(path: string, ob: any, parentObs: { [prop: string]: any }[]): void;
}
...
interface JQuery {
	...
	link(linkContent: boolean, data?: any, helpersOrContext?: JsViews.Hash<any>): JQuery;

	/* $(elemOrSelector).link(true, data ...) // Render and link contents */
	link(expression: string, data?: any, helpersOrContext?: JsViews.Hash<any>): JQuery;
...
interface Link {
	...
	(linkContent: boolean, container: string|Node|JQuery, data?: any, helpersOrContext?: Hash<any>): JQuery;

	/* $.link(expression, container, data) // Link existing contents */
	(expression: string, container: string|Node|JQuery, data?: any, helpersOrContext?: Hash<any>): JQuery;
